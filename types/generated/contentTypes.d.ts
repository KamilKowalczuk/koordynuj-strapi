...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imie_nazwisko: Schema.Attribute.Text & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    notatki_wewnetrzne: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    publishedAt: Schema.Attribute.DateTime;
    status_wiadomosci: Schema.Attribute.Enumeration<
      ['nowa', 'przeczytana', 'odpowiedziano', 'archiwum']
    > &
    ...
    wiadomosc: Schema.Attribute.RichText &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
...
export interface ApiProblemProblem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    icon: Schema.Attribute.Enumeration<
      ['revenue-loss', 'legal-risk', 'inefficiency']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSeoBlogListSeoBlogList extends Struct.SingleTypeSchema {
  collectionName: 'seo_blog_lists';
  info: {
    displayName: 'seo-blog-list';
    pluralName: 'seo-blog-lists';
    singularName: 'seo-blog-list';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::seo-blog-list.seo-blog-list'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', true>;
...
export interface ApiSeoHomeSeoHome extends Struct.SingleTypeSchema {
  collectionName: 'seo_homes';
  info: {
    displayName: 'seo-home';
    pluralName: 'seo-homes';
    singularName: 'seo-home';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    benefitsFacility: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    benefitsPatients: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    collaborationModel: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    collaborationSummary: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whyWorthIt: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::seo-blog-list.seo-blog-list': ApiSeoBlogListSeoBlogList;
      'api::seo-home.seo-home': ApiSeoHomeSeoHome;
